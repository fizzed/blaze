...
import static com.fizzed.blaze.Contexts.withUserDir;
...
//        final VirtualVolume source = localVolume(withUserDir("workspace/third-party/coredns"));
//        final VirtualVolume source = localVolume(withUserDir("workspace/third-party/jsch"));
//        final VirtualVolume source = localVolume(withUserDir("workspace/third-party/nats.java"));
//        final VirtualVolume source = localVolume((withUserDir("workspace/third-party/tokyocabinet-1.4.48"));
        final VirtualVolume source = localVolume(withUserDir("Downloads"));
