...
Download `blaze.jar` to your project directory.  If you have `wget` available
    ...
    wget -O blaze.jar 'http://repo1.maven.org/maven2/com/fizzed/blaze-lite/0.8.2/blaze-lite-0.8.2.jar'

If you have `curl` available

    curl -o blaze.jar 'http://repo1.maven.org/maven2/com/fizzed/blaze-lite/0.8.2/blaze-lite-0.8.2.jar'

Or simply [download the file in your web browser](http://repo1.maven.org/maven2/com/fizzed/blaze-lite/0.8.2/blaze-lite-0.8.2.jar)
